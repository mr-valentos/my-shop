...
const productSlice = createSlice({
    ...
    initialState: {
      product: [
        ...
        {name: 'Cabbage', category: 'vegetables',subcategory:'cabbage', description: 'fresh cabbage', brand: 'Biofarm', rating: 4, price: 5.99, discount: false, id: 2},
        ...
        {name: 'Milk ECO', category: 'milk products',subcategory:'milk', description: 'milk 0%', brand: 'Biofarm', rating: 5, price: 3.99, discount: false, id: 6},
      ]
    },
    reducers: {
      // Header
